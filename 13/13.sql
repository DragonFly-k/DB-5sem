...
begin
dbms_output.put_line('count of teachers '||get_num_teachers('ศั่า'));
end;
...
begin
dbms_output.put_line('count of teachers '||GET_NUM_TEACHERS_BY_FAC('าฮย'));
end; 
...
FUNC_RES2 number;
begin
teachers.get_teachers_by_faculty('าฮย');
TEACHERS.GET_SUBJECTS('ศั่า');
FUNC_RES1 := TEACHERS.GET_NUM_TEACHERS('าฮย');
dbms_output.put_line(FUNC_RES1);
FUNC_RES2 := TEACHERS.GET_NUM_SUBJECTS('ศั่า');
